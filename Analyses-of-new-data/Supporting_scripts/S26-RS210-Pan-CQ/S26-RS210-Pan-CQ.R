...
metadataListNames <- list(# WGS data
  "metaRSFinalWISNonzero_HiSeq_WGS",
  "metaRSFinal5050_Nonzero_HiSeq_WGS",
  "metaRSFinal7575_Nonzero_HiSeq_WGS",
  "metaRSFinal9090_Nonzero_HiSeq_WGS",
...
baseNamePerDatasetResultsFile <- "perfML_10k_tcga_RS210Pan_CQ_16Oct23"
baseNameAllResultsFile <- "perfML_10k_tcga_RS210Pan_CQ_ALL_16Oct23"
