...
## WIS
# # WGS PT
# cqWGS_PT_WIS <- mlMulticlass(metaData = metaRSFinalWISNonzero_HiSeq_WGS,
#                             countData = rs210PanFinalWISNonzero_HiSeq_WGS_CQ,
#                             sampleType = "Primary Tumor", numKFold = 10, seqCenter = "WGS_CQ")
# save(cqWGS_PT_WIS, file = "../../Interim_data/multiclass_CQ_WGS_PT_WIS_13Oct23.RData")

# # WGS BDN
# cqWGS_BDN_WIS <- mlMulticlass(metaData = metaRSFinalWISNonzero_HiSeq_WGS,
#                              countData = rs210PanFinalWISNonzero_HiSeq_WGS_CQ,
#                              sampleType = "Blood Derived Normal", numKFold = 10, seqCenter = "WGS_CQ")
# save(cqWGS_BDN_WIS, file = "../../Interim_data/multiclass_CQ_WGS_BDN_WIS_13Oct23.RData")

# # RNA
# cqRNA_PT_WIS <- mlMulticlass(metaData = metaRSFinalWISNonzero_HiSeq_RNA,
#                              countData = rs210PanFinalWISNonzero_HiSeq_RNA_CQ,
#                              sampleType = "Primary Tumor", numKFold = 10, seqCenter = "RNA_CQ")
# save(cqRNA_PT_WIS, file = "../../Interim_data/multiclass_CQ_RNA_PT_WIS_13Oct23.RData")

## rs210Pan_Filt9090
# # WGS PT
# cqWGS_PT_Filt9090 <- mlMulticlass(metaData = metaRSFinal9090_Nonzero_HiSeq_WGS,
#                              countData = rs210PanFinal9090_Nonzero_HiSeq_WGS_CQ,
#                              sampleType = "Primary Tumor", numKFold = 10, seqCenter = "WGS_CQ")
# save(cqWGS_PT_Filt9090, file = "../../Interim_data/multiclass_CQ_WGS_PT_Filt9090_13Oct23.RData")

# WGS BDN
# cqWGS_BDN_Filt9090 <- mlMulticlass(metaData = metaRSFinal9090_Nonzero_HiSeq_WGS,
#                                   countData = rs210PanFinal9090_Nonzero_HiSeq_WGS_CQ,
#                                   sampleType = "Blood Derived Normal", numKFold = 10, seqCenter = "WGS_CQ")
# save(cqWGS_BDN_Filt9090, file = "../../Interim_data/multiclass_CQ_WGS_BDN_Filt9090_13Oct23.RData")
# # RNA PT
# cqRNA_PT_Filt9090 <- mlMulticlass(metaData = metaRSFinal9090_Nonzero_HiSeq_RNA,
#                              countData = rs210PanFinal9090_Nonzero_HiSeq_RNA_CQ,
#                              sampleType = "Primary Tumor", numKFold = 10, seqCenter = "RNA_CQ")
# save(cqRNA_PT_Filt9090, file = "../../Interim_data/multiclass_CQ_RNA_PT_Filt9090_13Oct23.RData")

## rs210Pan_Filt7575
# # WGS PT
# cqWGS_PT_Filt7575 <- mlMulticlass(metaData = metaRSFinal7575_Nonzero_HiSeq_WGS,
#                              countData = rs210PanFinal7575_Nonzero_HiSeq_WGS_CQ,
#                              sampleType = "Primary Tumor", numKFold = 10, seqCenter = "WGS_CQ")
# save(cqWGS_PT_Filt7575, file = "../../Interim_data/multiclass_CQ_WGS_PT_Filt7575_13Oct23.RData")

# # WGS BDN
# cqWGS_BDN_Filt7575 <- mlMulticlass(metaData = metaRSFinal7575_Nonzero_HiSeq_WGS,
#                                   countData = rs210PanFinal7575_Nonzero_HiSeq_WGS_CQ,
#                                   sampleType = "Blood Derived Normal", numKFold = 10, seqCenter = "WGS_CQ")
# save(cqWGS_BDN_Filt7575, file = "../../Interim_data/multiclass_CQ_WGS_BDN_Filt7575_13Oct23.RData")

# # RNA PT
# cqRNA_PT_Filt7575 <- mlMulticlass(metaData = metaRSFinal7575_Nonzero_HiSeq_RNA,
#                              countData = rs210PanFinal7575_Nonzero_HiSeq_RNA_CQ,
#                              sampleType = "Primary Tumor", numKFold = 10, seqCenter = "RNA_CQ")
# save(cqRNA_PT_Filt7575, file = "../../Interim_data/multiclass_CQ_RNA_PT_Filt7575_13Oct23.RData")


## rs210Pan_Filt5050
# # WGS PT
# cqWGS_PT_Filt5050 <- mlMulticlass(metaData = metaRSFinal5050_Nonzero_HiSeq_WGS,
#                              countData = rs210PanFinal5050_Nonzero_HiSeq_WGS_CQ,
#                              sampleType = "Primary Tumor", numKFold = 10, seqCenter = "WGS_CQ")
# save(cqWGS_PT_Filt5050, file = "../../Interim_data/multiclass_CQ_WGS_PT_Filt5050_13Oct23.RData")

# # WGS BDN
# cqWGS_BDN_Filt5050 <- mlMulticlass(metaData = metaRSFinal5050_Nonzero_HiSeq_WGS,
#                                   countData = rs210PanFinal5050_Nonzero_HiSeq_WGS_CQ,
#                                   sampleType = "Blood Derived Normal", numKFold = 10, seqCenter = "WGS_CQ")
# save(cqWGS_BDN_Filt5050, file = "../../Interim_data/multiclass_CQ_WGS_BDN_Filt5050_13Oct23.RData")

# # RNA PT
# cqRNA_PT_Filt5050 <- mlMulticlass(metaData = metaRSFinal5050_Nonzero_HiSeq_RNA,
#                              countData = rs210PanFinal5050_Nonzero_HiSeq_RNA_CQ,
#                              sampleType = "Primary Tumor", numKFold = 10, seqCenter = "RNA_CQ")
# save(cqRNA_PT_Filt5050, file = "../../Interim_data/multiclass_CQ_RNA_PT_Filt5050_13Oct23.RData")

# # RNA PT
# cqCMS_PT_Filt5050 <- mlMulticlass(metaData = metaRSFinal5050_Nonzero_HiSeq_CMS,
#                              countData = rs210PanFinal5050_Nonzero_HiSeq_CMS,
#                              sampleType = "Primary Tumor", numKFold = 10, seqCenter = "CMS_CQ")
# save(cqCMS_PT_Filt5050, file = "../../Interim_data/multiclass_CMSonly_RNA_PT_Filt5050_21Oct23.RData")
