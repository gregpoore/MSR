...
load("../../Interim_data/KU_All_BIO_data_for_ml_tcga_by_seq_center_15Oct23.RData")
...
sampleTypeList <- c("Blood Derived Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(# Subset HG38 count data
...
datasetListNames <- c(# Subset HG38 count data
  "kuAllFinalNonzero_BIO_HG38_HiSeq_HMS",
  "kuAllFinalNonzero_BIO_HG38_HiSeq_BCM",
  "kuAllFinalNonzero_BIO_HG38_HiSeq_MDA",
  "kuAllFinalNonzero_BIO_HG38_HiSeq_WashU",
...
metadataListNames <- list(# HG38 data
  "metaKUAllFinalNonzero_BIO_HiSeq_HMS",
  "metaKUAllFinalNonzero_BIO_HiSeq_BCM",
  "metaKUAllFinalNonzero_BIO_HiSeq_MDA",
  "metaKUAllFinalNonzero_BIO_HiSeq_WashU",
...
baseNamePerDatasetResultsFile <- "perfML_10k_tcga_KU_All_BIO_seqcenter_15Oct23"
baseNameAllResultsFile <- "perfML_10k_tcga_KU_All_BIO_seqcenter_ALL_15Oct23"
