...
load("shogun_genus_raw_and_NoHu_data_for_ml_tcga_by_seq_center_18Sept23.RData")
...
sampleTypeList <- c("Blood Derived Normal",
                    ...
                    "Primary Tumor")
# MODIFY AS NEEDED
datasetList <- list(# Subset genus raw count data
...
baseNamePerDatasetResultsFile <- "perfML_10k_tcga_Shogun_raw_NoHu_18Sept23"
baseNameAllResultsFile <- "perfML_10k_tcga_Shogun_raw_NoHu_ALL_18Sept23"
