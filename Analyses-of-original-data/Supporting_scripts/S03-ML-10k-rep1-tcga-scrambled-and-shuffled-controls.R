#-----------------------------------------------------------------------------
# S03-ML-10k-rep1-tcga-scrambled-and-shuffled-controls.R
...
## Import data
load("shuffled_controls_raw_data_TCGA_25July22.RData")
...
datasetList <- list(tcgaGenusKrakenQCFiltWIS_HMS,
...
datasetListNames <- c("tcgaGenusKrakenQCFiltWIS_HMS",
     "tcgaGenusKrakenQCFiltWIS_BCM",
     "tcgaGenusKrakenQCFiltWIS_MDA",
     "tcgaGenusKrakenQCFiltWIS_WashU",
     "tcgaGenusKrakenQCFiltWIS_Broad_WGS",
...
metadataList <- list(metadataSamplesAllQC_HiSeq_HMS,
...
metadataListNames <- list("metadataSamplesAllQC_HiSeq_HMS_scrambled",
     ...
     "metadataSamplesAllQC_HiSeq_HMS_shuffled",
     "metadataSamplesAllQC_HiSeq_BCM_shuffled",
     "metadataSamplesAllQC_HiSeq_MDA_shuffled",
     "metadataSamplesAllQC_HiSeq_WashU_shuffled",
     "metadataSamplesAllQC_HiSeq_Broad_WGS_shuffled",
     "metadataSamplesAllQC_HiSeq_UNC_shuffled",
     "metadataSamplesAllQC_HiSeq_CMS_shuffled",
     "metadataSamplesAllQC_HiSeq_Broad_RNA_shuffled")

baseNamePerDatasetResultsFile <- "perfML_10k_tcga_wis_feature_subset_scrambled_and_shuffled_controls_25July22"
baseNameAllResultsFile <- "perfML_10k_tcga_wis_feature_subset_scrambled_and_shuffled_controls_ALL_25July22"
