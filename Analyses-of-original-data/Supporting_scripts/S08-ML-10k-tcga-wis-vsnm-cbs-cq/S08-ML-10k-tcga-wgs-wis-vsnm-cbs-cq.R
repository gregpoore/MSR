#-----------------------------------------------------------------------------
# S01-ML-10k-tcga-wis-feature-subset-per-seqcenter-and-vsnm.R
...
datasetList <- list(# Subset raw count data
  as.data.frame(tcgaGenusKrakenAllFiltWIS_HiSeq_WGS_CQ),
  as.data.frame(tcgaGenusKrakenAllFiltWIS_HiSeq_WGS_CQP),
  as.data.frame(tcgaGenusKrakenAllFiltWIS_HiSeq_WGS_CQ_libsize),
  as.data.frame(tcgaGenusKrakenAllFiltWIS_HiSeq_WGS_CQP_libsize),
  tcgaGenusKrakenAllFiltWIS_HiSeq_WGS_CBS,
  tcgaGenusKrakenAllFiltWIS_HiSeq_WGS_VSNM,
  
  as.data.frame(tcgaGenusKrakenAllFiltWIS_HiSeq_RNA_CQ),
  as.data.frame(tcgaGenusKrakenAllFiltWIS_HiSeq_RNA_CQP),
  as.data.frame(tcgaGenusKrakenAllFiltWIS_HiSeq_RNA_CQ_libsize),
  as.data.frame(tcgaGenusKrakenAllFiltWIS_HiSeq_RNA_CQP_libsize),
...
datasetListNames <- c(# Subset raw count data
  ...
  "tcgaGenusKrakenAllFiltWIS_HiSeq_WGS_CQP",
  "tcgaGenusKrakenAllFiltWIS_HiSeq_WGS_CQ_libsize",
  "tcgaGenusKrakenAllFiltWIS_HiSeq_WGS_CQP_libsize",
  "tcgaGenusKrakenAllFiltWIS_HiSeq_WGS_CBS",
  "tcgaGenusKrakenAllFiltWIS_HiSeq_WGS_VSNM",
  
  "tcgaGenusKrakenAllFiltWIS_HiSeq_RNA_CQ",
  "tcgaGenusKrakenAllFiltWIS_HiSeq_RNA_CQP",
  "tcgaGenusKrakenAllFiltWIS_HiSeq_RNA_CQ_libsize",
  "tcgaGenusKrakenAllFiltWIS_HiSeq_RNA_CQP_libsize",
  "tcgaGenusKrakenAllFiltWIS_HiSeq_RNA_CBS",
  "tcgaGenusKrakenAllFiltWIS_HiSeq_RNA_VSNM")
...
baseNamePerDatasetResultsFile <- "perfML_10k_tcga_wis_vsnm_cbs_cq_21Aug23"
baseNameAllResultsFile <- "perfML_10k_tcga_wis_vsnm_cbs_cq_ALL_21Aug23"
